...
class ProcessingThread(QThread):
    ...
    def __init__(self, input_path, fish_image_path, output_path, process_mode):
        super().__init__()
    ...
    def run(self):
        try:
            if self.process_mode == "file":
                ...
                self.convert_tiff_to_fishquant(self.input_path, cy3_filename, self.output_path)
                ...
                for i, filename in enumerate(tiff_files):
                    ...
                    try:
                        self.convert_tiff_to_fishquant(input_file, cy3_filename, output_file)
                        processed_files += 1
                    except Exception as e:
    ...
    def convert_tiff_to_fishquant(self, input_file, cy3_filename, output_file):
...
class Mask2OutlineTool(QMainWindow):
    ...
    def initUI(self):
        ...
        input_layout.addWidget(fish_btn, 1, 2)
